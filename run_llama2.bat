@echo off
if "%~1"=="" (
    echo Usage: run_llama2.bat "your prompt here"
    echo.
...
if "%CPI_MODEL%"=="" (
    echo [run_llama2] CPI_MODEL is not set. Set it to the path of your .ll2c file.
    exit /b 1
)
if "%CPI_TOKENIZER%"=="" (
    echo [run_llama2] CPI_TOKENIZER is not set. Set it to the path of your tokenizer file.
    exit /b 1
)
