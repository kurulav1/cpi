...
struct CachePage {
  ...
  std::uint64_t last_access =
      0;  // Monotonically increasing tick value of the last touch_page() call.
};
...
public:
  ...
  void initialize(std::size_t num_pages, std::size_t page_bytes, std::size_t max_device_pages);
