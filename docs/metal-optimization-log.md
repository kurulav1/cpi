# Metal optimization and verification log

The full investigation history of the Metal backend, moved out of the README. Kept verbatim:
the dead ends and retractions in here are the record of what was measured, what was falsified,
and why the current kernels look the way they do. The README carries the current state; this
file carries how it got there.
